...
class SystemMemoryStatusCapability(GatewayBackedCapability):
    ...
    manifest = CapabilityManifest(
        ...
        output_object_types=["system.memory", "system.resources", "table"],
        output_fields=["memory", "swap", "rows", "available_bytes", "available_human", "used_percent"],
        output_affordances=["returns.available_memory", "returns.memory_table", "returns.system_resource_metrics"],
